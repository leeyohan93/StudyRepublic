...
/*	@Query( value = "select s.name from study_member sm left join study s using (study_id)where id=:id and (sm.study_member_status_code = 'ME'  or sm.study_member_status_code = 'LE')", nativeQuery = true)
	List <StudyMember> joinedstudymember(String id);*/
