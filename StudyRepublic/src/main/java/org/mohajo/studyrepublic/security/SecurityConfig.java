...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http
		.authorizeRequests()
		.antMatchers("/login", "/member/signup").anonymous()
		.antMatchers("/","/StudyPage/**","/index","/member/**").permitAll()
		.antMatchers("/tutor/signup","/tutor/insert","/pay","/board/**").hasAnyRole("N","W","T","A")
		.antMatchers("/tutor/inquery","/tutor/file/**","/tutor/delete/**").hasAnyRole("W","T","A")
