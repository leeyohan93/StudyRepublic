...
//		log.info("채팅입장하는사람 : " + chatMessage.getSender());

		// 유저리스트에 접속자 추가
//		log.info("유저리스트: " + userList.toString());

//		for (int i = 0; i < userList.size(); i++) {
//			log.info("유저리스트 for문 돌려보기: " + userList.get(i));
//			if (chatMessage.getSender() == userList.get(i)) {
//				log.info("이럼에러야~");
//
//			} else {
//				log.info("요거냐?");
